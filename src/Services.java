...
public class Services {
    ...
    public void SetUniver() {
        univer = new Univer("Boston", (int) Math.round((Math.random() * 85) + 18));
    }
    ...
    public void Election() {
        ...
        for (int el = 0; el < univer.students.size(); el++) {
            ...
            for (int can = 0; can < univer.students.size(); can++) {
                ...
                if (elector.isPresent()) {
                    ...
                    System.out.println(elector.getName() + " gives student with id:" + candid.getId() + " " + candid.getName() + " " + rating + " points ");
                }
            }
        }
        ...
        for (int i = 0; i < univer.students.size(); i++) {
            ...
            System.out.println(" Student name " + student.getName() + " Election rating " + univer.election.getScore(student.getId()));
    ...
    public void UnivStructure() {
        ...
        System.out.println(univer.StudNumber + " students study here.");
        System.out.println("Famous professors working here: ");
        for (int i = 0; i < univer.professors.size(); i++) {
            Professor prof = univer.professors.get(i);
            System.out.println("Mr. " + prof.name);
        }
        System.out.println("There are 4 Groups:");
        ...
        } else System.out.println("There are no teamleader selected. Please select one (button 3)");
        System.out.println(" ");
